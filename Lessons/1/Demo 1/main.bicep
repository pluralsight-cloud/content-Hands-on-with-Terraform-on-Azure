...
resource VM1CSE 'Microsoft.Compute/virtualMachines/extensions@2020-12-01' = {
  ...
  properties: {
    ...
    protectedSettings: {
      fileUris: [
        'https://raw.githubusercontent.com/pluralsight-cloud/content-Hands-on-with-Terraform-on-Azure/main/Lessons/Helpers/Set-Workstation1.ps1'
      ]
      commandToExecute: 'powershell.exe -ExecutionPolicy Bypass -File Set-Workstation1.ps1'
    }
  }
}
